...
class _AmbitHitmapBetween(
    ...
    def _perform_operation(
        ...
        """
        Perform a generic AMBIT BETWEEN (vl < # < vh) query operation assuming reserved space for hitmaps.
...
class AmbitHitmapBetween(_AmbitHitmapBetween):
    def perform_operation(
        ...
        """
        Perform an AMBIT BETWEEN (vl< # < vh) query operation. If the PI/Key field is segmented, specify the segment
...
class AmbitHitmapInverseBetween(_AmbitHitmapBetween):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
        ...
        """
        Perform an AMBIT INVERSE BETWEEN !(vl< # < vh) query operation. If the PI/Key field is segmented, specify the
