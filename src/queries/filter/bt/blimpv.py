...
class BlimpVHitmapBetween(_BlimpVHitmapBetween):
    def perform_operation(
        ...
        """
        Perform an BLIMP-V BETWEEN (vl< # < vh) query operation. If the PI/Key field is segmented, specify the segment
...
class BlimpVHitmapInverseBetween(_BlimpVHitmapBetween):
    def perform_operation(
            self,
            pi_element_size_bytes: int,
            value_low: int,
        ...
        """
        Perform an BLIMP-V INVERSE BETWEEN !(vl< # < vh) query operation. If the PI/Key field is segmented, specify the
