...
class _BlimpAmbitHitmapLessThan(
    Query[
    ...
    def _perform_operation(
        ...
        """
        Perform a generic BLIMP+AMBIT LESS THAN (<) query operation assuming reserved space for hitmaps.
...
class BlimpAmbitHitmapLessThan(_BlimpAmbitHitmapLessThan):
    def perform_operation(
        ...
        """
        Perform a BLIMP+AMBIT LESS THAN (<) query operation. If the PI/Key field is segmented, specify the segment
...
class BlimpAmbitHitmapGreaterThanOrEqual(_BlimpAmbitHitmapLessThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
