...
class BlimpAmbitHitmapInverseLessThan(_BlimpAmbitHitmapLessThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
        ...
        """
        Perform a BLIMP+AMBIT INVERSE LESS THAN (!<) query operation. If the PI/Key field is segmented, specify the
