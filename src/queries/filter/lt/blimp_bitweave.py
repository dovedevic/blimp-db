...
class _BlimpBitweaveHitmapLessThan(
    Query[
        SimulatedBlimpBank,
        Union[
            BlimpHitmapIndexBitweaveBankLayoutConfiguration
    ...
    def _perform_operation(
        ...
        """
        Perform a generic BLIMP LESS THAN (<) query operation.
...
class BlimpBitweaveHitmapLessThan(_BlimpBitweaveHitmapLessThan):
...
class BlimpBitweaveHitmapGreaterThanOrEqual(_BlimpBitweaveHitmapLessThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
