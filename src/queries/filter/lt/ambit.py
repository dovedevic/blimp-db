...
class _AmbitHitmapLessThan(
    ...
    def _perform_operation(
        ...
        """
        Perform a generic AMBIT LESS THAN (<) query operation assuming reserved space for hitmaps.
...
class AmbitHitmapLessThan(_AmbitHitmapLessThan):
    def perform_operation(
        ...
        """
        Perform an AMBIT LESS THAN (<) query operation. If the PI/Key field is segmented, specify the segment offset
