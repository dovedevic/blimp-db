...
class _BlimpBitweaveHitmapEquality(
    Query[
        SimulatedBlimpBank,
        Union[
            BlimpHitmapIndexBitweaveBankLayoutConfiguration
...
class BlimpBitweaveHitmapEqual(_BlimpBitweaveHitmapEquality):
...
class BlimpBitweaveHitmapNotEqual(_BlimpBitweaveHitmapEquality):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
