...
class _BlimpVBitweaveHitmapEquality(
    Query[
        SimulatedBlimpVBank,
        Union[
            BlimpHitmapIndexBitweaveBankLayoutConfiguration
...
class BlimpVBitweaveHitmapEqual(_BlimpVBitweaveHitmapEquality):
...
class BlimpVBitweaveHitmapNotEqual(_BlimpVBitweaveHitmapEquality):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
