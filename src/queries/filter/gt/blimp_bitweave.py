...
class _BlimpBitweaveHitmapGreaterThan(
    Query[
        SimulatedBlimpBank,
        Union[
            BlimpHitmapIndexBitweaveBankLayoutConfiguration
    ...
    def _perform_operation(
        ...
        """
        Perform a generic BLIMP GREATER THAN (>) query operation.
...
class BlimpBitweaveHitmapGreaterThan(_BlimpBitweaveHitmapGreaterThan):
...
class BlimpBitweaveHitmapLessThanOrEqual(_BlimpBitweaveHitmapGreaterThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
        ...
        """
        Perform a BLIMP LESS THAN OR EQUAL (<=) query operation. If the PI/Key field is segmented, specify the
