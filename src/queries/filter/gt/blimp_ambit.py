...
class _BlimpAmbitHitmapGreaterThan(
    Query[
    ...
    def _perform_operation(
        ...
        """
        Perform a generic BLIMP+AMBIT GREATER THAN (>) query operation assuming reserved space for hitmaps.
...
class BlimpAmbitHitmapGreaterThan(_BlimpAmbitHitmapGreaterThan):
    def perform_operation(
        ...
        """
        Perform a BLIMP+AMBIT GREATER THAN (>) query operation. If the PI/Key field is segmented, specify the segment
