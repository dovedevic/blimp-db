...
class _AmbitHitmapGreaterThan(
    ...
    def _perform_operation(
        ...
        """
        Perform a generic AMBIT GREATER THAN (>) query operation assuming reserved space for hitmaps.
...
class AmbitHitmapGreaterThan(_AmbitHitmapGreaterThan):
    def perform_operation(
        ...
        """
        Perform an AMBIT GREATER THAN (>) query operation. If the PI/Key field is segmented, specify the segment offset
...
class AmbitHitmapInverseGreaterThan(_AmbitHitmapGreaterThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
        ...
        """
        Perform an AMBIT INVERSE GREATER THAN (!>) query operation. If the PI/Key field is segmented, specify the
