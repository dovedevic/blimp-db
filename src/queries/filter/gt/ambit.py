...
class AmbitHitmapLessThanOrEqual(_AmbitHitmapGreaterThan):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
        ...
        """
        Perform an AMBIT LESS THAN OR EQUAL (<=) query operation. If the PI/Key field is segmented, specify the
