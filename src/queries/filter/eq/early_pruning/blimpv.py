...
class BlimpVHitmapEarlyPruningEqual(_BlimpVHitmapEarlyPruningGenericScalarALO):
...
class BlimpVHitmapEarlyPruningNotEqual(_BlimpVHitmapEarlyPruningGenericScalarALO):
    def perform_operation(
            self,
            pi_element_size_bytes: int,
            value: int,
