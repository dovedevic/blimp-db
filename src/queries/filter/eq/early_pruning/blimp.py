...
class BlimpHitmapEarlyPruningEqual(_BlimpHitmapEarlyPruningGenericScalarALO):
...
class BlimpHitmapEarlyPruningNotEqual(_BlimpHitmapEarlyPruningGenericScalarALO):
    def perform_operation(
            self,
            pi_element_size_bytes: int,
            value: int,
