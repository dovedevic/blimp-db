...
class _AmbitEarlyTerminationHitmapEquality(
    Query[
        SimulatedAmbitBank,
        Union[
            AmbitHitmapBankLayoutConfiguration,
    ...
    def _perform_operation(
        ...
        for h in range(rows_per_hitmap):
            ...
            for b in range(pi_element_size_bytes * 8):
                ...
                runtime += self.simulator.cpu_cycle(2, "; cmp early termination frequency", return_labels)
...
class AmbitEarlyTerminationHitmapEqual(_AmbitEarlyTerminationHitmapEquality):
...
class AmbitEarlyTerminationHitmapNotEqual(_AmbitEarlyTerminationHitmapEquality):
    def perform_operation(
            self,
            pi_subindex_offset_bytes: int,
            pi_element_size_bytes: int,
