...
from src.configurations.database.blimp import BlimpVectorDatabaseConfiguration
...
class BlimpVAggregate(
    Query[
        SimulatedBlimpVBank,
        DataLayoutConfiguration[
            BlimpVectorHardwareConfiguration, BlimpVectorDatabaseConfiguration,
    ...
    def perform_operation(
        ...
        """
        Perform a BLIMP-V aggregate operation on a provided array.
        """
        ...
        for d in range(self.layout_configuration.row_mapping.data[1]):
            ...
            runtime += self.simulator.blimpv_alu_int_redsum(
