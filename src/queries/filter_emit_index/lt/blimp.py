from src.queries.filter_emit_index._generic.blimp import _BlimpFilterEmitIndexGenericScalarALO
...
class BlimpLessThanEmitIndex(_BlimpFilterEmitIndexGenericScalarALO):
