...
from studies.star_schema_benchmark.queries.q3.q3_x import SSBQuery3pX, SSBQuery3pXSupplierCustomerDate, \
    SSBQuery3pXCustomerSupplierDate, Hash32bitObject8bPayload
...
class SSBQuery3p1(SSBQuery3pX):
    def _supplier_record_joined_hashtable_object(self, record: SSBSupplierTable.TableRecord):
        return Hash32bitObject8bPayload(record.supplier_key, record.nation)
...
class SSBQuery3p1BlimpVSupplierCustomerDate(SSBQuery3pXSupplierCustomerDate, SSBQuery3p1):
    ...
    supplier_join_hash_table = BlimpVSupplierHashMap(4096, 8192)
    customer_join_hash_table = BlimpVCustomerHashMap(65536, 131072)
...
class SSBQuery3p1BlimpSupplierCustomerDate(SSBQuery3pXSupplierCustomerDate, SSBQuery3p1):
    ...
    supplier_join_hash_table = BlimpSupplierHashMap(131072, 262144)
    customer_join_hash_table = BlimpCustomerHashMap(524288, 1048576)
