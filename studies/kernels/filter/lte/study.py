...
from src.queries.filter.lte.blimpv import BlimpVHitmapLessThanOrEqual
from src.queries.filter.lte.blimp_ambit import BlimpAmbitHitmapLessThanOrEqual
from src.queries.filter.lte.blimpv_bitweave import BlimpVBitweaveHitmapLessThanOrEqual
from src.queries.filter.lte.blimp_bitweave import BlimpBitweaveHitmapLessThanOrEqual
...
ambit_studies = [
    QueryStudy(
        ...
        query_type=AmbitHitmapLessThanOrEqual,
        name="ambit",
    ),
]
...
blimp_studies = [
    QueryStudy(
        ...
        query_type=BlimpHitmapLessThanOrEqual,
        name="blimp",
    ),
    QueryStudy(
        ...
        hardware_type=BlimpBank,
        simulator_type=SimulatedBlimpBank,
        query_type=BlimpBitweaveHitmapLessThanOrEqual,
        name="blimp bitweave",
    ),
]
...
blimpv_studies = [
    QueryStudy(
        ...
        query_type=BlimpVHitmapLessThanOrEqual,
        name="blimpv",
    ),
    QueryStudy(
        layout_configuration_type=BlimpHitmapIndexBitweaveBankLayoutConfiguration,
        ...
        hardware_type=BlimpVectorBank,
        simulator_type=SimulatedBlimpVBank,
        query_type=BlimpVBitweaveHitmapLessThanOrEqual,
...
blimp_ambit_studies = [
    QueryStudy(
        ...
        query_type=BlimpAmbitHitmapLessThanOrEqual,
        name="blimp ambit",
    ),
]
