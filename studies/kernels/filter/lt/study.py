...
# from src.queries.filter.lt.early_termination.ambit import AmbitEarlyTerminationHitmapLessThan
# from src.queries.filter.lt.early_termination.blimp_bitweave import BlimpEarlyTerminationBitweaveHitmapLessThan
# from src.queries.filter.lt.early_termination.blimpv_bitweave import BlimpVEarlyTerminationBitweaveHitmapLessThan
# from src.queries.filter.lt.early_termination.blimp_ambit import BlimpAmbitEarlyTerminationHitmapLessThan
...
ambit_studies = [
    ...
    #     hardware_type=AmbitBank,
    #     simulator_type=SimulatedAmbitBank,
    #     query_type=AmbitEarlyTerminationHitmapLessThan,
...
blimp_studies = [
    ...
    #     hardware_type=BlimpBank,
    #     simulator_type=SimulatedBlimpBank,
    #     query_type=BlimpEarlyTerminationBitweaveHitmapLessThan,
...
blimpv_studies = [
    ...
    #     hardware_type=BlimpVectorBank,
    #     simulator_type=SimulatedBlimpVBank,
    #     query_type=BlimpVEarlyTerminationBitweaveHitmapLessThan,
...
blimp_ambit_studies = [
    ...
    #     hardware_type=BlimpAmbitBank,
    #     simulator_type=SimulatedBlimpAmbitBank,
    #     query_type=BlimpAmbitEarlyTerminationHitmapLessThan,
