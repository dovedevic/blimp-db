...
from src.queries.filter.gt.ambit import AmbitHitmapGreaterThan
from src.queries.filter.gt.blimp import BlimpHitmapGreaterThan
from src.queries.filter.gt.blimpv import BlimpVHitmapGreaterThan
from src.queries.filter.gt.blimp_ambit import BlimpAmbitHitmapGreaterThan
from src.queries.filter.gt.blimpv_bitweave import BlimpVBitweaveHitmapGreaterThan
from src.queries.filter.gt.blimp_bitweave import BlimpBitweaveHitmapGreaterThan
...
ambit_studies = [
    QueryStudy(
        ...
        query_type=AmbitHitmapGreaterThan,
        name="ambit",
    ),
]
...
blimp_studies = [
    QueryStudy(
        ...
        query_type=BlimpHitmapGreaterThan,
        name="blimp",
    ),
    QueryStudy(
        ...
        hardware_type=BlimpBank,
        simulator_type=SimulatedBlimpBank,
        query_type=BlimpBitweaveHitmapGreaterThan,
        name="blimp bitweave",
    ),
]
...
blimpv_studies = [
    QueryStudy(
        ...
        query_type=BlimpVHitmapGreaterThan,
        name="blimpv",
    ),
    QueryStudy(
        layout_configuration_type=BlimpHitmapIndexBitweaveBankLayoutConfiguration,
        ...
        hardware_type=BlimpVectorBank,
        simulator_type=SimulatedBlimpVBank,
        query_type=BlimpVBitweaveHitmapGreaterThan,
...
blimp_ambit_studies = [
    QueryStudy(
        ...
        query_type=BlimpAmbitHitmapGreaterThan,
        name="blimp ambit",
    ),
]
